    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="rounded-[1.75rem] border border-[color:var(--line)] bg-white p-6">
          ...
          <h2 className="mt-2 font-serif text-3xl text-[color:var(--navy)]">
            Subscribe for a weekly preview
          </h2>
          <p className="mt-3 text-sm leading-6 text-slate-700">
            Choose a county, optional city, and a few interests. Email sending
            is stubbed for now, but subscriptions are stored and previewed in
            admin.
          </p>
