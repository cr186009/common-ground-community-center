import type { AlertSeverity, AlertType, Category, MeetingType, SourceSection, SourceType, SubmissionType } from "@/types/hub";

export const SITE_NAME =
  import.meta.env.VITE_SITE_NAME || "Common Ground Digital Community Center";
